...
echo_and_run cd "/home/bart/CFD_pipeline/simulation_ws/src/turtlebot/turtlebot_create/create_node"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/bart/CFD_pipeline/simulation_ws/build/turtlebot/turtlebot_create/create_node" \
    install \
    --root="${DESTDIR-/}" \
