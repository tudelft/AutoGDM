...
echo_and_run cd "/home/bart/CFD_pipeline/simulation_ws/src/openai_ros/openai_ros"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/bart/CFD_pipeline/simulation_ws/build/openai_ros/openai_ros" \
    install \
    --root="${DESTDIR-/}" \
