...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_gazebo_SOURCE_PREFIX /home/bart/CFD_pipeline/simulation_ws/src/turtlebot/turtlebot_gazebo)
  set(turtlebot_gazebo_DEVEL_PREFIX /home/bart/CFD_pipeline/simulation_ws/devel)
  ...
  set(turtlebot_gazebo_INSTALL_PREFIX /home/bart/CFD_pipeline/simulation_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bart/CFD_pipeline/simulation_ws/src/turtlebot/turtlebot_gazebo/${idir}'.  ${_report}")
    endif()
