...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simulated_anemometer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bart/CFD_pipeline/simulation_ws/src/gaden/simulated_anemometer/${idir}'.  ${_report}")
    endif()
