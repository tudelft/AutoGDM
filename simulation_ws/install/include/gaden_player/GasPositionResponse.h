...
bool operator==(const ::gaden_player::GasPositionResponse_<ContainerAllocator1> & lhs, const ::gaden_player::GasPositionResponse_<ContainerAllocator2> & rhs)
{
  return lhs.gas_conc == rhs.gas_conc &&
