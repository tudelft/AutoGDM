...
get_filename_component(_filename "/home/bart/CFD_pipeline/catkin_ws/src/gaden/gaden_player/srv/GasPosition.srv" NAME_WE)
add_custom_target(_gaden_player_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "gaden_player" "/home/bart/CFD_pipeline/catkin_ws/src/gaden/gaden_player/srv/GasPosition.srv" ""
)

get_filename_component(_filename "/home/bart/CFD_pipeline/catkin_ws/src/gaden/gaden_player/srv/WindPosition.srv" NAME_WE)
add_custom_target(_gaden_player_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "gaden_player" "/home/bart/CFD_pipeline/catkin_ws/src/gaden/gaden_player/srv/WindPosition.srv" ""
)
