...
if("TRUE" STREQUAL "TRUE")
  set(simulated_anemometer_SOURCE_PREFIX /home/bart/CFD_pipeline/catkin_ws/src/gaden/simulated_anemometer)
  set(simulated_anemometer_DEVEL_PREFIX /home/bart/CFD_pipeline/catkin_ws/devel)
  ...
  set(simulated_anemometer_INSTALL_PREFIX /home/bart/CFD_pipeline/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simulated_anemometer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bart/CFD_pipeline/catkin_ws/src/gaden/simulated_anemometer/${idir}'.  ${_report}")
    endif()
